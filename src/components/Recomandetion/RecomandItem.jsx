...
const RecomandItem = ({ item }) => {
  ...
  return (
    <div className="space-y-4 flex items-center justify-center flex-col shadow p-6 rounded-md ">
      ...
      <button className="bg-gray-100 cursor-pointer text-yellow-400 py-1.5 px-8 rounded-md border-b-2 hover:border-none hover:bg-gray-700 transition-all duration-400 border-yellow-300">
        Add To Cart
      </button>
    </div>
  );
